...
(
    ...
    CONSTRAINT pk_plans_plan_id PRIMARY KEY (plan_id),
...
(
    ...
    CONSTRAINT fk_subscriptions_plan_id FOREIGN KEY (plan_id)
        REFERENCES foodie_fi.plans (plan_id),
    start_date  DATE
);
